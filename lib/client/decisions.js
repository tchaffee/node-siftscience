...
function getDecisionsApi(siftScienceClient) {
  ...
  return {
     ...
     * @param {Object} [data]
     * @param {Object} [params]
     * https://sift.com/developers/docs/curl/decisions-api/apply-decisions
     */
    applyByAccountIdAndUserIdAndContentId(accountId, userId, contentId, data = {}, params = {}) {
      ...
      return Promise.resolve(v3HttpClient.post(`/accounts/${accountId}/users/${userId}/content/${contentId}/decisions`, data, params, {
          auth: {
            username: key
          }
        }))
